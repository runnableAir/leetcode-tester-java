...
public class CommonMethodInterpreter<T> extends MethodInterpreter<T> {
     ...
     * <p>
     * This method takes the arguments from the Command object as input
     * and uses the argument resolvers of the target method to handle them.
     * <p>
     * <b>The resolvers read one or more arguments from the input to resolve
     * and generate a single argument.</b>
     * The order in which the arguments are generated by the resolvers should
     * match the order in which the types are declared in the argument list
     * of the target method.
     * This also implies that the arguments from the input should occur in
     * the correct order.
     *
